dc.leafletChart = function(_chart) {
  ...
  //----------------------------------------------------------------------------------------
    ...
    //   console.log("minEvents in here: ", minEvents)

    //     var div = L.DomUtil.create('div', 'info legend'),
    //         grades = [0, 10, 20, 50, 100, 200, 500, 1000, 1500, 2000],
    //         labels = [];            
    ...
    _legend.update = function (compGrades) {   
      console.log("compGrades: ", compGrades)   
