dc.leafletChart = function(_chart) {
  ...
  // _legend.getminmax = function () {
  //   console.log("getminmax choroChart.minmaxEvents().apply(choroChart): ", choroChart.colorDomain())
  //   eventRange = choroChart.colorDomain();
