dc.leafletChart = function(_chart) {
  ...
  _info.update = function (props) {        
        this._div.innerHTML = '<h4>Extreme Events</h4>' +  (props ?
            ...
            //       + ' events above threshold'
             '<b>' + props.key + '</b><br />' + Math.round(100 * props.value.count / ( indexCount  * timeAggCount * datasetCount )) + ' events'
  ...
  _chart.doRender = function() {
    if (_map != undefined) { _map.remove(); } //http://stackoverflow.com/questions/19186428/refresh-leaflet-map-map-container-is-alreay-initialized
