...
dc.colorChart = function(_chart) {
    ...
    var _colorDomain = [0, _colors.range(colorbrewer.YlGn[7]).length];    
    ...
    var _colorCalculator = function(value) {   
        ...
        //console.log("_colorDomain in dc.js _colorCalculator: ", _colorDomain)
        ...
        //console.log("_colors.range().length: ", _colors.range().length)
    ...
    **/
    ...
    _chart.getColor = function(d, i){
        // console.log("_colorAccessor(d, i): ", _colorAccessor(d, i))
        // console.log("_colorCalculator(_colorAccessor(d, i)): ", _colorCalculator(_colorAccessor(d, i)))
